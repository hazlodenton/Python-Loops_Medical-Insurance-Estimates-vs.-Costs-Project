...
for i in range(len(names)): 
  ...
  if insurance_cost > average_cost:
    print(str(name) + "'s" + " insurance cost is above the average")
  elif insurance_cost < average_cost:
    print(str(name) + "'s" + " insurance cost is below the average")
  else: 
    print(str(name) + "'s" + " insurance cost is equal to the average")
  print("--------")
